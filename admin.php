...
<body>
    <center>
        <div class="box">
            <strong><h1>Admin Page</h1></strong>
        </div>
    </center><br>
    <br>
    <center>
        <div class="box" style="height: 400px;padding-left: 20px;padding-top: 40px;">
            ...
            <a href="add_bugs_admin.php">Add Bugs</a></br><br>
            <a href="add_comment_admin.php">Add Comment</a></br><br>
        </div>
    </center>
    <center>
        <div class="bigbox">
                ...
                while($row = $result->fetch_assoc()) {
                    ...
                    if ($row["comment"]==NULL){
                        if($row["status"]==0)
                        {
                            ...
                            <td>'."Open".'</td>
                            <td><a
                            href="change_to_working_admin.php?id='.$row["id"].'"
                            class="complex">Working</a></td>
                            <td><a href="change_to_closed_admin.php?id='.$row["id"].'"
